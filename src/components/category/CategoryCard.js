  ...
  return (
    <>
      <a
        ...
        className="p-2 flex items-center rounded-md hover:bg-gray-50 w-full hover:text-orange-300"
        role="button"
      >
        {icon ? (
            ...
            <li key={children._id}>
              {children.children.length > 0 ? (
                <a
                  ...
                  className="flex items-center font-serif pr-2 text-sm text-gray-600 hover:text-orange-600 py-1 cursor-pointer"
                >
                ...
                <a
                  ...
                  className="flex items-center font-serif py-1 text-sm text-gray-600 hover:text-orange-800 cursor-pointer"
                >
