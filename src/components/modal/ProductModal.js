          ...
          <div className="flex flex-col lg:flex-row md:flex-row w-full max-w-4xl overflow-hidden">
            ...
            <div className="w-full flex flex-col p-5 md:p-8 text-left">
              ...
              {product?.affiliateLink && (
                <div className="mt-4">
                  <span className="font-semibold text-sm">{t("common:affiliateLink")}:</span>
                  <input
                    type="text"
              ...
              onClick={() => window.open(product.slug, "_blank")}
                //onClick={() => handleMoreInfo(product.slug)}
                className="cursor-pointer text-center mt-3 hover:bg-gray-200 py-3 border-t-2"
              >
                <span className="font-semibold text-xs">{t("common:moreInfo")}</span>
              </div>
            </div>
          </div>
        </div>
