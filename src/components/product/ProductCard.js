...
//             );
//           }}
//           className="relative flex justify-center cursor-pointer pt-2 w-full h-60" // Increased height
//         >
...
const ProductCard = ({ product, attributes }) => {
  ...
  const currency = "₹"; // Adjust if you have dynamic currency fetching logic
    ...
    <>
      ...
      <div className="group box-border overflow-hidden flex rounded-md shadow-sm pe-0 flex-col items-center bg-white relative">
        ...
        <div
          ...
          className="relative flex justify-center cursor-pointer pt-2 w-full h-60"
        >
          <div className="relative w-full h-full p-2">
            {product.image[0] ? (
              <ImageWithFallback src={product.image[0]} alt="product" />
          ...
          {product.affiliateLink && (
            <div className="mt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center text-white py-2 px-4 rounded-md"
                style={{ backgroundColor: "#0b5052" }}
              >
                Buy Now
              </a>
            </div>
