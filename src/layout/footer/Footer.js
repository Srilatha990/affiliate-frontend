              ...
              <ul className="text-sm flex flex-col space-y-3">
                <li className="flex items-baseline">
                  <Link
                    ...
                    className="text-gray-600 inline-block w-full hover:text-orange-300"
                  >
                    <CMSkeleton
                      count={1}
                      height={10}
...
<div className="relative">
                    {/* Responsive h1 for AffiliateInsight */}
                    <h1
                      style={{
                        fontWeight: "bold",
                        color: "#0b5052",
                        fontSize: "clamp(1.5rem, 2.5vw, 3rem)", // Responsive font size
                      }}
                    >
                      AffiliateInsight
                    </h1>
            ...
            <div className="col-span-1 text-center hidden lg:block md:block">
              {storeCustomizationSetting?.footer?.bottom_contact_status && (
                <div>
                  ...
                  <h5 className="text-2xl font-bold leading-7" style={{color:'#0b5052'}}>
                    {/* +012345-67900 */}
